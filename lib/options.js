...
const bsfmtOptions = {
  ...
  indentSpaceCount: {
    type: 'int',
    default: 4,
    description: 'The number of spaces to use when indentStyle is "spaces". Default is 4. Has no effect if formatIndent is false or if indentStyle is set to "tabs".'
  },
  formatIndent: {
    type: 'boolean',
    default: true,
  ...
  keywordCase: {
    ...
    default: 'lower',
    description: 'Replaces all keywords with the upper or lower case settings specified (excluding types...see typeCase). If set to "original", they are not modified at all.'
  }
};
